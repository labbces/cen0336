...
Sofia Robb
   ...
   * [Aulas de Python](pfb.md/#aulas-de-python)
      ...
      * [Python 3](pfb.md/#python-3)
         ...
         * [Cordas](pfb.md/#cordas)
            * [Aspas](pfb.md/#aspas)
            * [Cordas e a função print()](pfb.md/#cordas-e-a-função-print)
            * [Caracteres especiais e de escape](pfb.md/#caracteres-especiais-e-de-escape)
            * [Concatenação](pfb.md/#concatenação)
            * [A diferença entre a corda   e o integrador  ](pfb.md/#a-diferença-entre-a-corda--e-o-integrador-)
            * [Determinar a extensão de uma corda](pfb.md/#determinar-a-extensão-de-uma-corda)
            * [Alterando o caso da corda](pfb.md/#alterando-o-caso-da-corda)
            * [Encontrar e contar](pfb.md/#encontrar-e-contar)
            * [Substituir uma corda com outra](pfb.md/#substituir-uma-corda-com-outra)
            * [Extraindo um subtermo, ou separando](pfb.md/#extraindo-um-subtermo-ou-separando)
            * [Reverter uma corda ou uma lista](pfb.md/#reverter-uma-corda-ou-uma-lista)
            * [Outros métodos de corda](pfb.md/#outros-métodos-de-corda)
         * [Formatação de corda](pfb.md/#formatação-de-corda)
